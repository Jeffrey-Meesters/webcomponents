...
class JBtn extends s{constructor(){super();this.text="btn";}_clicked(){console.log(`clicked ${this.text}`);}render(){return $`<button @click=${this._clicked}>${this.text}</button>`;}}_defineProperty(JBtn,"properties",{text:{}});_defineProperty(JBtn,"styles",r$3`
    button {
      width: 100px;
      height: 40px;
      border-radius: 5px;
